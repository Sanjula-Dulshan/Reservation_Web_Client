  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* BackOffice */}
        <Route path="/backoffice" exact Component={isBackOffice ? BackOffice : Login} />
        <Route path="/schedule" exact Component={isBackOffice ? Schedule : Login} />
        <Route path="/updateschedule" exact Component={isBackOffice ? UpdateSchedule : Login} />
        <Route path="/allschedules" exact Component={isBackOffice ? AllSchedules : Login} />
